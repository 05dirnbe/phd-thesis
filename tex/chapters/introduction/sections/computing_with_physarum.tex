...
\section{Natural Computing with \P}\label{sec:natural_computing_physarum}
	...
	\subsection{Natural computing approaches}
		...
		\subsubsection{Computing with live \P}
			...
			\caption[\P neurons setup]{L.h.s.: \P expanding unrestrictedly from an inoculation site. R.h.s.: \P placed in a star-shaped container. Reprinted from~\cite{Aono:2007:ANC:1284621.1284651}.}
