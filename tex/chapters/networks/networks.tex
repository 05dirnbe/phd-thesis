...
\section{Results}
	...
	\subsection{Path properties}
		...
		\begin{figure}
			...
			\caption[Path length distributions.]{Empirical cumulative path length distributions for \series{22} (a) and \series{35} (b). Associated gamma and log-normal fits are shown. Abscissa in units of pixel.}
		...
		\begin{figure}
			...
			\caption[Path width distributions.]{Empirical cumulative distributions of average path widths for \series{22} (a) and \series{35} (b). Associated gamma and log-normal fits are shown. Abscissa in units of pixel.}
