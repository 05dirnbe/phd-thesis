...
\section{Sample Usage of the KIST Europe Data Set}
	...
	\begin{figure}
		...
		\caption[Demo - Setup for tracking individual edges]{Details of a \emph{P. polycephalum} graph, see dashed rectangle in \Fref{fig:graph}. L.h.s.: Two edges $A$ and $B$ are selected for tracking. R.h.s.: A third edge appears, causing $B$ to split up and disappear from its track.}
    \end{figure}
