...
This appendix contains figures supplementing \Fref{chap:networks}. Note that the full set of goodness-of-fit plots for all data series is available online at the \SMGR. 
\vfill
\begin{figure}[!htbp]
\begin{center}%
...
\begin{figure}[!htbp]
\begin{center}%
  \includegraphics[width=\textwidth]{path_length/physical_edge_length_histogram_cummulative_motion22.png}
\end{center}%
